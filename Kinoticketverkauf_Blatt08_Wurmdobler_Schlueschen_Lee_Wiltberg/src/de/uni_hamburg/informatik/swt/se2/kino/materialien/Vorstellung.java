...
public class Vorstellung
{
            ...
            Uhrzeit endzeit, Datum datum, Geldbetrag preis)
    {
        ...
        assert preis.istGueltigerbetrag(preis.getEuroAnteil(), preis
            .getCentAnteil()) : "Vorbedingung verletzt: istGueltigerbetrag == true";
    ...
    public Geldbetrag getPreisFuerPlaetze(Set<Platz> plaetze)
    {
        ...
        return _preis.multipliziere(_preis, plaetze.size());
    }
