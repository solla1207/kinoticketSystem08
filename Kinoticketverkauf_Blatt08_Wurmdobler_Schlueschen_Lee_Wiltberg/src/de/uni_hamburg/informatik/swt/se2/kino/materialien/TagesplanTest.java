...
{
    private static final Datum _datum = Datum.get(1, 1, 2020);
    ...
    private static final Vorstellung _vorstellung = new Vorstellung(_kinosaal,
            _film, _startzeit, _endzeit, _datum, Geldbetrag.select(10, 0));
    private static final Vorstellung _vorstellung2 = new Vorstellung(_kinosaal,
            _film, _startzeit2, _endzeit, _datum, Geldbetrag.select(10, 0));
