...
public class PlatzVerkaufsWerkzeug
{
     ...
     */
    //    TODO GELDBETRAG  die Variable "preis" muss zum Typ Geldbetrag geändert werden.
    private void aktualisierePreisanzeige(Set<Platz> plaetze)
    {
        if (istVerkaufenMoeglich(plaetze))
        {
            ...
            _ui.getPreisLabel()
                .setText("Gesamtpreis: " + preis.getFormatiertenGeldbetrag()
                        + " Eurocent");
        ...
        else if (istStornierenMoeglich(plaetze))
        {
            Geldbetrag preis = _vorstellung.getPreisFuerPlaetze(plaetze);
            _ui.getPreisLabel()
                .setText("Gesamtstorno: " + preis.getFormatiertenGeldbetrag()
                        + " Eurocent");
        }
